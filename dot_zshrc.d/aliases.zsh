...
alias cat="mcat -t vscode -S --report --hyprlink -a "
alias icat="mcat -t vscode -S --report --hyprlink -a -o interactive "
...
yt-dlp() {
  sudo yt-dlp --config-locations /home/sudar/.config/yt-dlp/config "$1"
