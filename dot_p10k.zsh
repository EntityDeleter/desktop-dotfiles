# Generated by Powerlevel10k configuration wizard on 2025-07-25 at 09:59 IST.
...
# 12h time, vertical separators, sharp heads, blurred tails, 2 lines, dotted,
# right frame, sparse, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=110
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=35
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=35
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%I:%M:%S %p, %A, %B %d}'
